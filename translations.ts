...
export const translations = {
  en: {
    ...
    help: {
      ...
      description: "A modern, native Markdown explorer and editor for Windows, powered by Google Gemini AI.",
      features: "Features",
      feature1: "Gemini AI Integration (Chat & Summarize)",
